...
const BackgroundDiagnoses = ({data, classes}) => {
    const { rows, name_category } = data;

    if (!rows.length) return null;

    return (
        <div className={`${classes.preview_main_sensitivity_to_substances}`}>
...
export default BackgroundDiagnoses;