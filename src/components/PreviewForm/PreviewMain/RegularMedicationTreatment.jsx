...
const RegularMedicationTreatment = ({data, classes}) => {
    const { rows, name_category } = data;

    if (!rows.length) return null;

    return (
        <div className={`${classes.preview_main_regular_medication_treatment}`}>
...
RegularMedicationTreatment.propTypes = {
...
export default RegularMedicationTreatment;